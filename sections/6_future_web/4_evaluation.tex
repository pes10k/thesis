...
the source \HTML of the page being viewed is no guarantee, since \JS could have
manipulated where the form values will be sent.  \CDF removes these
uncertainties by only allowing forms and sub-page requests to send to the
current domain.
